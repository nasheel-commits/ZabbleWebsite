...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      // Favicon set (generated by scripts/gen-favicon.mjs). SVG first for modern
      // browsers; the multi-size .ico is the legacy + Google-SERP fallback;
      // apple-touch-icon covers iOS home-screen. Ink tile + cyan-barred "Z".
      link: [
