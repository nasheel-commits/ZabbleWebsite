...
export function renderLeadConfirmationEmail(d: LeadEmailData): {
  ...
  const subject = `You're booked in: your Zabble call on ${d.dateLabel}`
  ...
  const profileBlock = profile
    ? `<tr><td style="padding:0 36px;">
         <div style="border-top:1px solid ${LINE};padding-top:26px;">
           ...
           <div style="font-family:${SANS};font-size:14px;line-height:1.65;color:${MUTE};margin-top:10px;">That's our read from your answers, and only a starting point. On the call we'll map the wider operational picture, which is usually broader than a short form can capture.</div>
         </div>
       </td></tr>`
    : ''
...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;font-size:1px;line-height:1px;color:${BG};">Your ${d.durationMin}-minute discovery call with Zabble is confirmed for ${esc(whenLine)}.</div>
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 24px 60px -32px rgba(15,23,42,0.28);">
        ...
        <tr><td style="padding:24px 36px 6px 36px;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:12px;">
            <tr><td style="font-family:${SANS};font-size:15px;line-height:1.6;color:${INK_SOFT};padding:6px 0;"><span style="color:${CYAN_DEEP};font-weight:700;">·</span>&nbsp; No slide deck and no pitch. Just a real conversation.</td></tr>
            ...
            <tr><td style="font-family:${SANS};font-size:15px;line-height:1.6;color:${INK_SOFT};padding:6px 0;"><span style="color:${CYAN_DEEP};font-weight:700;">·</span>&nbsp; You leave with a clear first move, whether or not we work together.</td></tr>
          </table>
        </td></tr>
        ...
        <tr><td style="padding:22px 36px 30px 36px;">
          <div style="font-family:${SERIF};font-size:17px;color:${INK};">Talk soon, the Zabble team</div>
        </td></tr>
